...
PgwTftStatsCalculator::PgwTftStatsCalculator ()
{
  ...
  Config::Connect (
    "/NodeList/*/ApplicationList/*/$ns3::EpcController/PgwTftStats",
...
PgwTftStatsCalculator::NotifyPgwTftStats (
  std::string context, EpcController::PgwTftStats stats)
{
  ...
  *m_tftWrapper->GetStream ()
  ...
  << right
  << " " << setw (8) << stats.currentLevel
  << " " << setw (7) << stats.nextLevel
  << " " << setw (7) << stats.maxLevel
  << " " << setw (7) << numTfts
  << " " << setw (7) << stats.bearersMoved
  << " " << setw (7) << stats.blockThrs
  << " " << setw (7) << stats.splitThrs
  << " " << setw (7) << stats.joinThrs
