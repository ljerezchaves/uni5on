...
#ifndef ONOFF_UDP_TRACE_CLIENT_H
#define ONOFF_UDP_TRACE_CLIENT_H
...
/**
 * \ingroup onoff
 * \class OnOffUdpTraceClient
 * \brief A on/off trace based streamer
 *
 ...
 * During the "On" state, traffic is generated based on trace file.
 */
class OnOffUdpTraceClient : public Application
{
public:
  /**
   ...
   *
   */
  OnOffUdpTraceClient (Ipv4Address ip, uint16_t port, char *traceFile);
  ~OnOffUdpTraceClient ();
...
#endif /* ONOFF_UDP_TRACE_CLIENT_H */
