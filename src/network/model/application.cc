...
Application::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Application")
    ...
    .AddAttribute ("StopTime", "Time at which the application will stop",
                   ...
                   MakeTimeChecker ())
    .AddAttribute ("Direction", "Traffic direction generated by this application",
                   EnumValue (UNKNOWN),
                   MakeEnumAccessor (&Application::m_direction),
                   MakeEnumChecker (UNKNOWN, "Unknown",
                                    DOWNLINK, "Downlink",
                                    UPLINK, "Uplink",
...
Application::GetDirection () const
{
  return m_direction;
}
