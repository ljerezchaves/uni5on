...
public:
   ...
   * \param start The start callback to invoke
   * \param stop The stop callback to invoke
   */
  void SetAppStartStopCallback (AppSendingCallback_t start, AppSendingCallback_t stop);

  /**
   * \returns the traffic direction generated by this application
   */
...
protected:
  ...
  AppSendingCallback_t  m_startSendingCallback;  //!< Application start sending callback
  AppSendingCallback_t  m_stopSendingCallback;   //!< Application stop sending callback

  Direction m_direction;    //!< The traffic direction
};
